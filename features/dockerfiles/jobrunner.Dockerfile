FROM docker-registry.wikimedia.org/dev/bookworm-php83-jobrunner:1.0.0-s4 AS build
...
FROM docker-registry.wikimedia.org/dev/bookworm-php83-jobrunner:1.0.0-s4
